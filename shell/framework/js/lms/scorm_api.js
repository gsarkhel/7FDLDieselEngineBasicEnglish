...
function fnScormVersion(win){
 ...
 while ((win.API_1484_11 == null && (win.API == null)) && (win.parent != null) && (win.parent != win)) // client updates
   {
      findAPITries++;
      if (findAPITries > 500) 
      {
...
function set_val( gname,gvalue )
{
	...
	if( API != null )
	{
		...
		{
			console.log(" :: SCORM SET :: "+gname+" :: SCORM SET::  "+gvalue+" :: SCORM typeof::  "+typeof(gvalue))
...
{	
	...
	if( API != null )
	{
		console.log(" :: SCORM Bookmark_location :: "+Bookmark_location+" :: SCORM completionStatus::  "+completionStatus+" :: SCORM timeValue::  "+timeValue)		
		if(scorm_version=="2004"){			
