function reviewTool(debugMode, obj) {
    ...
    const init = () => {
        ...
        document.querySelector(".ui-page").appendChild(objToolWrapper['toolWrapper']);
